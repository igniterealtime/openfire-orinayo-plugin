 ...
 */
public class OjuRedirectFilter implements Filter
{
    private static final Logger Log = LoggerFactory.getLogger( OjuRedirectFilter.class );
    ...
    {
        return request.getRequestURI().matches( request.getContextPath() + "/oju/([^/]+)$" );
    }
    ...
    protected boolean containsExcludedExtension( HttpServletRequest request )
    {
        ...
        if (uri.contains("/ohun")) return true;
    ...
    public void doFilter( ServletRequest servletRequest, ServletResponse response, FilterChain filterChain ) throws IOException, ServletException
    {
        if ( servletRequest instanceof HttpServletRequest )
        {
            ...
            else
            {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher( "/oju/" );
