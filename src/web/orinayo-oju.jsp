...
<% 
	...
	String 	url = "https://" + publicHost + "/orinayo/oju/";		
%>

<html>
<head>
<title><fmt:message key="admin.sidebar.webclients.item.oju.description" /></title>
<meta name="pageID" content="orinayo-oju"/>
<style type="text/css">
...
%>
<div><fmt:message key="orinayo.oju.desc" /><a target="_blank" href="<%= url %>"><%= url %></a></div>
<%
	}
%>
</body>
